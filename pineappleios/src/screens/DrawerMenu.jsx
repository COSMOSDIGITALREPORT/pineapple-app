            ...
            <LinearGradient
              ...
              <View style={styles.walletTopRow}>
                <View style={styles.walletBalanceBadge}>
                  <Text style={styles.walletBalanceBadgeText}>💰 BALANCE</Text>
                </View>
                <TouchableOpacity
              ...
              <Text style={styles.walletSubText}>coins available · tap to recharge</Text>
            </LinearGradient>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  spinItemLeft: { flexDirection: 'row', alignItems: 'center', gap: 12 ,padding: 9,},
  zapIconWrap: {
    width: 32,
    height: 32,
    borderRadius: 10,
  ...
  premiumInfo: { flex: 0.9, },
  premiumTitle: { fontSize: 15,fontWeight: 'bold',color: Colors.dark },
  premiumSub: { fontSize: 12,color: Colors.textLight,marginTop: 2 },
  supportRow: {
