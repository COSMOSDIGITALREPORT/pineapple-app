        ...
        <View style={styles.card}>
          ...
          {devOtp ? (
            <View style={styles.devOtpBadge}>
              <Text style={styles.devOtpHint}>🔑 OTP: <Text style={styles.devOtpCode}>{devOtp}</Text></Text>
            </View>
          ) : null}
...
const styles = StyleSheet.create({
  ...
  errorBox: {
    backgroundColor: 'rgba(255,56,112,0.08)', borderRadius: 14, padding: 14,
    marginBottom: 16, borderWidth: 1, borderColor: 'rgba(255,56,112,0.25)',
    flexDirection: 'row', alignItems: 'flex-start', gap: 10,
  },
  errorTitle: { fontSize: 14, fontWeight: '800', color: Colors.primary, marginBottom: 3 },
  errorMsg: { fontSize: 13, color: '#7a0030', flexShrink: 1 },
  ...
  devOtpBadge: {
    backgroundColor: 'rgba(255,56,112,0.08)', borderRadius: 10,
    paddingHorizontal: 14, paddingVertical: 8, marginBottom: 12,
    alignSelf: 'center', borderWidth: 1, borderColor: 'rgba(255,56,112,0.2)',
  },
  devOtpHint: { fontSize: 13, color: Colors.primary, fontWeight: '600', textAlign: 'center' },
  devOtpCode: { fontWeight: '900', letterSpacing: 2 },
});
