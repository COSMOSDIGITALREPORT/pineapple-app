...
const SECTIONS = [
  ...
  {
    title: '3. Virtual Coins & Calling Minutes',
    body: 'Coins purchased within the app are virtual items used to connect with hosts via voice or video calls and to send virtual gifts. Virtual coins are non-refundable once purchased or consumed.',
  },
  {
    title: '4. Code of Conduct & Safety',
    body: 'We maintain zero tolerance for harassment, hate speech, explicit illegal content, extortion, threats, or fraud. Users can report and block any abusive party at any time.',
  },
  {
    title: '5. Audio & Video Calling Rules',
  ...
  {
    title: '6. Account Termination & Moderation',
