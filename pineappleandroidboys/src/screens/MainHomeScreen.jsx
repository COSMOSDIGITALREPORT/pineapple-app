...
export default function MainHomeScreen({ onFindMatch, onRooms, onWallet, onPremium, onDrawer, onNotifications, onLuckySpin, onCallUser }) {
        ...
        <View style={styles.featureRow}>
          <TouchableOpacity style={styles.featureCardTall} onPress={onLuckySpin} activeOpacity={0.9}>
            <LinearGradient colors={['#FF3870', '#FF8A5B']} style={styles.featureCardGrad}>
              ...
              <Text style={styles.featureSub}>Win rewards</Text>
            </LinearGradient>
          </TouchableOpacity>
          ...
          <View style={styles.featureColRight}>
            ...
            <TouchableOpacity style={styles.featureCardSmall} onPress={onPremium} activeOpacity={0.9}>
              <LinearGradient colors={['#7C3AED', '#4F46E5']} style={styles.featureCardGrad}>
                <Text style={styles.featureEmoji}>👑</Text>
                <Text style={styles.featureTitle}>{user.isPremium ? 'Premium\nActive' : 'Go\nPremium'}</Text>
              </LinearGradient>
            </TouchableOpacity>
          </View>
        </View>
