      ...
      <ScrollView
        ...
        <View style={[styles.section, { marginTop: 24 }]}>
          ...
          <View style={styles.emptyState}>
                ...
                <Text style={styles.emptySub}>Spin the Fortune Wheel to win gifts!</Text>
              </View> :
...
const styles = StyleSheet.create({
  ...
  giftList: { gap: 12 },
  prizeGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 24 },
  prizeChip: { width: (SCREEN_W - 72) / 4, backgroundColor: '#fff', borderRadius: 16, padding: 12, alignItems: 'center', gap: 4, borderWidth: 1, borderColor: '#f1f5f9' },
  prizeEmoji: { fontSize: 22 },
  prizeName: { fontSize: 10, fontWeight: '700', color: Colors.dark },
  prizeWorth: { fontSize: 10, fontWeight: '600', color: Colors.secondary },
