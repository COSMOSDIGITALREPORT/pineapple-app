    ...
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      <View style={styles.selectedBanner}>
        ...
        <View style={styles.selectedCheck}>
          <Icon name="check" size={16} color="#FF3870" />
        </View>
      </View>
      ...
      <ScrollView
        ...
        {/* Regional */}
        <Text style={[styles.sectionLabel, { marginTop: 24 }]}>ALL LANGUAGES</Text>
...
const styles = StyleSheet.create({
  ...
  listRowSelected: { borderColor: '#FF3870', backgroundColor: '#FFE8EF' },
  ...
  radioActive: { borderColor: '#FF3870' },
  radioDot: {
    width: 10,
    height: 10,
    borderRadius: 5,
